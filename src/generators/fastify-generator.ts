...
export function generateFastifyTests(
  ...
  if (validRoutes.length === 0) {
    console.log("⚠ No valid routes found. Skipping Fastify test generation.");
    return;
  }
  ...
  console.log(`Generating ${validRoutes.length} Fastify tests...\n`);
